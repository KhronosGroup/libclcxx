...
kernel void worker7()
{
    static cl::pipe_storage<int4, 10> programPipe2;
    cl::pipe<int4> in = cl::make_pipe(programPipe2);
...
{
    static cl::pipe_storage<int4, 10> programPipe2;
    cl::pipe<int4, cl::pipe_access::write> out = cl::make_pipe<cl::pipe_access::write>(programPipe2);
